...
-- This will create the email templates table if it doesn't exist
...
CREATE INDEX IF NOT EXISTS idx_email_templates_active ON email_templates(tenant_id, template_type, is_active);
CREATE INDEX IF NOT EXISTS idx_email_send_log_tenant_date ON email_send_log(tenant_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_email_send_log_status ON email_send_log(tenant_id, status);
