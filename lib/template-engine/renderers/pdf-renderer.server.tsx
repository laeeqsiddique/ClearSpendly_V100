...
// This file is explicitly server-only

export class ServerPDFRenderer {
  ...
  generateCompleteDocument(config: TemplateConfig, invoiceData: InvoiceData): string {
    console.log('ServerPDFRenderer: Generating PDF HTML using React SSR');
...
export const serverPDFRenderer = new ServerPDFRenderer();