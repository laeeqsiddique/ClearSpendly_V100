...
ARG NEXT_PUBLIC_ENABLE_AI_ENHANCEMENT
ARG NEXT_PUBLIC_APP_URL
ARG RAILWAY_ENVIRONMENT

# Pass environment variables to the build (NEVER include API keys in NEXT_PUBLIC_*)
ENV NEXT_PUBLIC_SUPABASE_URL=$NEXT_PUBLIC_SUPABASE_URL
ENV NEXT_PUBLIC_SUPABASE_ANON_KEY=$NEXT_PUBLIC_SUPABASE_ANON_KEY
ENV NEXT_PUBLIC_ENABLE_AI_ENHANCEMENT=$NEXT_PUBLIC_ENABLE_AI_ENHANCEMENT
...
RUN echo "Building with environment variables:" && \
    ...
    echo "NEXT_PUBLIC_ENABLE_AI_ENHANCEMENT: $NEXT_PUBLIC_ENABLE_AI_ENHANCEMENT" && \
