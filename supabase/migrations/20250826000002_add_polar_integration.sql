-- Polar Integration Migration for ClearSpendly
-- Adds Polar-specific fields and improves subscription system
...
DROP CONSTRAINT IF EXISTS subscription_provider_check,
...
ALTER TABLE public.subscription 
ADD CONSTRAINT IF NOT EXISTS unique_polar_subscription 
...
-- 11. Update existing helper functions

-- Enhanced function to get current subscription with Polar data
...
-- Enhanced function to check usage with quota support
...
-- 12. Create triggers for automatic event logging
...
-- 13. Create automatic billing history updates
...
-- 14. Grant permissions on new tables and functions
...
-- 15. Insert sample Polar configuration for testing
